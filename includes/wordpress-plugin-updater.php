...
if (!class_exists('AW_GitHub_Plugin_Updater')) {
	...
	class AW_GitHub_Plugin_Updater
	{
		...
		{
			error_log("AW GitHub Plugin Updater: check_for_update called");
			error_log("AW GitHub Plugin Updater: Plugin = " . $this->plugin_slug);
			error_log("AW GitHub Plugin Updater: Version = " . $this->version);
			...
			error_log("AW GitHub Plugin Updater: Remote version = " . $remote_version);
	...
	if (current_user_can('manage_options')) {
		...
		if ($current_page == 'plugins.php') {
			...
			if (file_exists($plugin_file)) {
				...
				echo '<p><strong>AW GitHub Plugin Updater Debug:</strong><br>';
